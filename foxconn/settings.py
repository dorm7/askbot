...
DATABASES = {
    'default': {
        ...
        'NAME': '/tmp/askbot',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(os.path.dirname(__file__), 'askbot', 'media')
MEDIA_URL = '/media/'
...
SECRET_KEY = 'f804b660af421437f2a42528ce7b21f9'
...
ASKBOT_EXTRA_SKINS_DIR = os.path.join(PROJECT_ROOT, 'skins')
...
#   ASKBOT_URL = 'forum/'
#
ASKBOT_URL = 'askbot/' #no leading slash, default = '' empty string
